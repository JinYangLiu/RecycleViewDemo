...
/**
 * Created by Mr.LJY on 2017/8/11.
 */
...
public class AvatarImageBehavior extends CoordinatorLayout.Behavior<CircleImageView> {
    ...
    private void bindDimensions() {
        mAvatarMaxSize = mContext.getResources().getDimension(R.dimen.img_width);
    }
    ...
    private void shouldInitProperties(CircleImageView child, View dependency) {
        ...
        // Toolbar缩略图高度
        if (mFinalHeight == 0)
            mFinalHeight = mContext.getResources().getDimensionPixelOffset(R.dimen.img__final_width);
